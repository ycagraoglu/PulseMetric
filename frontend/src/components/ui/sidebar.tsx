...
//   Highlight,
//   HighlightItem,
// } from '@/components/ui/primitives/effects/highlight'; // Temporarily removed complex animation primitive
...
//   SheetHeader,
//   SheetTitle,
// } from '@/components/ui/sheet'; // TODO: Needed for mobile
...
function Sidebar({
    ...
    if (isMobile) {
        return (
            // Simplified mobile drawer (no sheet yet)
            openMobile ? (
                <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm">
                    <div className="fixed inset-y-0 left-0 z-50 h-full w-3/4 gap-4 border-r bg-background p-6 shadow-lg sm:max-w-sm">
